...
latex_documents = [
    (
        ...
        "on.tex",
        "on Documentation",
        "Staff of the NOS Storm Surge Modeling Team",
        "manual",
    ),
]
...
man_pages = [(main_doc, "on", "on Documentation", [author], 1)]
...
pdf_documents = [
    (
        main_doc,
        "UFS_Coastal_Application_Users_Guide",
        "UFS Coastal Application Users Guide (PDF)",
    )
]
